...
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=14), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Dimanche', 17.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=15), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Lundi', 16.3, 90));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=16), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Lundi', 16.3, 90));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=16), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=60), 'Lundi', 17.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=16), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=60), 'Lundi', 18.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=16), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=60), 'lundi', 19.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=16), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=60), 'Lundi', 20.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=16), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=6), 'Mercredi', 19.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=17), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=3), 'Samedi', 17.3, 120));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=17), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=3), 'Vendredi', 17.3, 120));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=17), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Dimanche', 17.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=17), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=3), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=3), 'Dimanche', 18.0, 30));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=17), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=3), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=3), 'Mardi', 20.0, 30));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=17), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=7), 'Mardi', 17.0, 90));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=18), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Lundi', 16.3, 90));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=18), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=60), 'Mardi', 19.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=18), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=7), 'Mercredi', 14.0, 120));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=18), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=7), 'Mercredi', 16.0, 90));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=19), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Dimanche', 17.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=20), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=6), 'Mercredi',19.0,60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=21), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Lundi', 16.3, 30));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=21), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=60), 'Mardi', 19.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=21), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Lundi', 16.3, 30));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=21), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=60), 'Mardi', 19.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=21), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=7), 'Mercredi', 17.0, 30));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=22), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Mardi', 10.0, 30));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=24), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=1), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=149), 'Jeudi', 9.0, 90));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=24), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Mercredi', 10.0, 90));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=25), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=1), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=149), 'Dimanche', 18.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=27), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=2), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=57), 'Jeudi', 10.0, 90));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=27), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=7), 'Mercredi', 14.0, 120));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=27), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=7),'Mercredi', 17.0, 90));

INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=28), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=1), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=149),'Lundi', 9.0, 30));

INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=28), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=6),'Dimanche', 14.0, 60));

INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=28), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=6),'Dimanche', 15.0, 60));

INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=28), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=6),'Dimanche', 16.0, 60));
INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=28), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=6),'Dimanche', 17.0, 60));

INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=28), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=7),'Mardi', 18.0, 90));

INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=28), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=7),'Samedi', 18.0, 90));

INSERT INTO Seances VALUES(TSEANCE((SELECT ref(g) FROM gymnases g WHERE g.idgymnase=28), (SELECT ref(sp) FROM SPORTS sp WHERE sp.idsport=5), (SELECT ref(spf) FROM SPORTIFS spf WHERE spf.idsportif=7),'Vendredi', 18.0, 90));
